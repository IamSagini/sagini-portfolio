...
const NAV = ["Work", "Skills", "Experience", "About", "Contact"];
 ...
 const PROJECTS = [
  {
    id: "01",
    name: "Sagini AI Analytics",
    sub: "AI-Powered Data Intelligence Platform",
    role: "Founder & Developer",
    period: "2026 – Present",
    desc: "Upload any dataset and instantly get AI-generated insights, interactive charts, anomaly detection, and shareable reports. Built for analysts and non-technical users who need enterprise-grade analytics without the complexity.",
    data: "Core platform built around Python and Pandas for data processing, Plotly for interactive visualisations, and FastAPI for the backend API layer. SQLite for lightweight persistence.",
    stack: ["FastAPI", "Python", "Pandas", "Plotly", "SQLite", "JavaScript"],
    link: "https://sagini.net",
    cta: "Visit Live",
    highlight: "Live at sagini.net — real datasets, real insights.",
  },
  {
    id: "02",
    name: "Devboard",
    sub: "Laravel JWT API Explorer Dashboard",
    role: "Founder & Developer",
    period: "2025 – Present",
    desc: "Production-ready Next.js 14 dashboard starter kit with a built-in API Explorer, JWT authentication, role-based access control, posts CRUD with likes, comments, replies and views. Dark mode, profile settings and database schema viewer included.",
    data: "Built to eliminate 40+ hours of boilerplate setup for Laravel developers. Pre-wired to any Laravel JWT REST API — connect and ship in minutes.",
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "JWT", "Axios", "Laravel"],
    link: "https://devboard-32ja.vercel.app",
    cta: "Live Demo",
    highlight: "Available on Contra — https://contra.com/iamsagini",
  },
  {
    id: "03",
    name: "Laravel JWT API Starter Kit",
    sub: "Production REST API Boilerplate",
    role: "Founder & Developer",
    period: "2025 – Present",
    desc: "Production-ready Laravel 13 REST API starter kit with JWT authentication, role-based access control, posts CRUD, likes, comments, replies and view tracking. Zero config SQLite database. Every endpoint tested and working.",
    data: "Register returns 201. Login returns 200 with a JWT token. Built to pair with Devboard for a complete full-stack application out of the box.",
    stack: ["Laravel", "PHP", "JWT", "SQLite", "REST API"],
    link: "https://laravel-api-starter-production.up.railway.app",
    cta: "Live API",
    highlight: "Available on Contra — https://contra.com/iamsagini",
  },
  {
